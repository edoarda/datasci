...
----- | ----- | -----
mmc1.xlsx | http://base1.org/ | Breve resumo (duas ou três linhas) sobre o dataset.
mmc2.xlsx | link | resumo
...
NetworkX | https://networkx.org/ | asas
PANDAS | https://pandas.pydata.org/ | ASA
...
### 2. Expand the KEGG Network
  ...
  *I swear I tried to get better pictures but my computer was giving up on me by this point. Also had to redo the script because I forgot the graph was bipartite. Ooops.*
  <br>
  ![First try graph, as shown on Cytoscape](assets/images/graph_before_death.png "What I could see from the second graph")
